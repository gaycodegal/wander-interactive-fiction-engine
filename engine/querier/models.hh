...
class Location {
	public:
		...
		Location() {}
		Location(std::string name_, std::shared_ptr<std::string> description_, std::shared_ptr<std::string> neighbors_, std::shared_ptr<std::string> characters_, std::shared_ptr<std::string> items_)
		...
		inline void setItems(std::shared_ptr<std::string> items) { this->m_items = move(items); }
		void dialogues();
		void items();
...
class Node {
	public:
		int id;
		Node() {}
		Node(int id_, std::string dialogue_)
